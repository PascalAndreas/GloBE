...
# GloBE Gate Projection Fitting Script
# This script fits global basis banks for Gate projections using weight-only reconstruction
...
CONFIG_NAME="default"
OUTPUT_DIR="outputs/globe_gate_fitting"
NUM_GPUS=1
WANDB_PROJECT="globe"
...
# Print configuration
echo "GloBE Gate Projection Fitting"
echo "============================="
...
export WANDB_RUN_NAME="globe_gate_${MODEL_NAME}_$(date +%Y%m%d_%H%M%S)"
...
echo ""
echo "Gate projection fitting completed!"
